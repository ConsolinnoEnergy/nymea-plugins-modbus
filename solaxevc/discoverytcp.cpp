...
SolaxEvcTCPDiscovery::SolaxEvcTCPDiscovery(NetworkDeviceDiscovery *networkDeviceDiscovery,
                                           QObject *parent)
...
void SolaxEvcTCPDiscovery::startDiscovery()
{
    ...
    connect(discoveryReply, &NetworkDeviceDiscoveryReply::networkDeviceInfoAdded, this,
            &SolaxEvcTCPDiscovery::checkNetworkDevice);
...
void SolaxEvcTCPDiscovery::checkNetworkDevice(const NetworkDeviceInfo &networkDeviceInfo)
{
    ...
    SolaxEvcModbusTcpConnection *connection =
            new SolaxEvcModbusTcpConnection(networkDeviceInfo.address(), port, modbusId, this);
    ...
    connect(connection, &SolaxEvcModbusTcpConnection::reachableChanged, this, [=](bool reachable) {
        ...
        connect(connection, &SolaxEvcModbusTcpConnection::initializationFinished, this,
                [=](bool success) {
                    if (!success) {
