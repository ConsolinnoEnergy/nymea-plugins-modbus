...
#ifndef GOODWEDISCOVERY_H
#define GOODWEDISCOVERY_H
...
class GoodweDiscovery : public QObject
{
    Q_OBJECT
public:
    explicit GoodweDiscovery(ModbusRtuHardwareResource *modbusRtuResource, QObject *parent = nullptr);
    struct Result {
