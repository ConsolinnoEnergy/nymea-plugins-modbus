...
SolaxEvcModbusTcpConnection::SolaxEvcModbusTcpConnection(const QHostAddress &hostAddress, uint port,
                                                         quint16 slaveId, QObject *parent)
    : ModbusTCPMaster(hostAddress, port, parent), m_slaveId(slaveId)
{
    connect(this, &ModbusTCPMaster::connectionStateChanged, this, [this](bool status) {
        if (status) {
            qCDebug(dcSolaxEvcModbusTcpConnection())
                    << "Modbus TCP connection" << m_hostAddress.toString()
                    << "connected. Start testing if the connection is reachable...";
            ...
            qCWarning(dcSolaxEvcModbusTcpConnection())
                    << "Modbus TCP connection diconnected from" << m_hostAddress.toString()
                    << ". The connection is not reachable any more.";
            m_communicationWorking = false;
            m_communicationFailedCounter = 0;
            m_checkReachableRetriesCount = 0;
        }
...
{
    QVector<quint16> values = ModbusDataUtils::convertFromUInt16(
            static_cast<quint16>(DataHubChargeCurrent * 1.0 / pow(10, -2)));
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Data hub charge current\" register:" << 4132 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4132, values.count());
...
{
    QVector<quint16> values = ModbusDataUtils::convertFromUInt32(
            static_cast<quint32>((0x0C80 << 16) | controlCommand), m_endianness);
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Control command\" register:" << 4135 << "size:" << 2 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4135, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
{
    QVector<quint16> values = ModbusDataUtils::convertFromUInt32(
            static_cast<quint32>(MaxCurrent * 1.0 / pow(10, -2)), m_endianness);
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Maximum current fast mode\" register:" << 4175 << "size:" << 2
            << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4175, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
{
    QVector<quint16> values = ModbusDataUtils::convertFromUInt16(
            static_cast<quint16>(MinCurrent * 1.0 / pow(10, -2)));
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Minimum AC line current\" register:" << 4159 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4159, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setDeviceMode(quint16 deviceMode)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Device mode\" register:" << 4109 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4109, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setEcoGear(quint16 ecoGear)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"ECO gear\" register:" << 4110 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4110, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setGreenGear(quint16 greenGear)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Green gear\" register:" << 4111 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4111, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setStartChargeMode(quint16 startChargeMode)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Start charge mode\" register:" << 4112 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4112, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setOverVoltSet(quint16 overVoltSet)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Over voltage setting\" register:" << 4113 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4113, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setUnderVoltSet(quint16 underVoltSet)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Under voltage setting\" register:" << 4114 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4114, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setBoostMode(quint16 boostMode)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Boost mode\" register:" << 4115 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4115, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setMainBreakerLimit(quint16 mainBreakerLimit)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Main breaker limit\" register:" << 4116 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4116, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setElectronicLock(quint16 electronicLock)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Electronic Lock\" register:" << 4117 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4117, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
QModbusReply *SolaxEvcModbusTcpConnection::setCardActivateSwitch(quint16 CardActivateSwitch)
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Write \"Card activate switch\" register:" << 4118 << "size:" << 1 << values;
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4118, values.count());
    request.setValues(values);
    return sendWriteRequest(request, m_slaveId);
}
...
bool SolaxEvcModbusTcpConnection::initialize()
{
    ...
    if (m_initObject) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Tried to initialize but the init process is already running.";
        return false;
    }
    ...
    // Read Version
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read init \"Version\" register:" << 4096 << "size:" << 14;
    reply = readSerialNumber();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Version\" registers from"
                << hostAddress().toString() << errorString();
    ...
    connect(reply, &QModbusReply::finished, m_initObject, [this, reply]() {
        ...
        qCDebug(dcSolaxEvcModbusTcpConnection()) << "<-- Response from init \"Version\" register"
                                                 << 4096 << "size:" << 14 << unit.values();
        processSerialNumberRegisterValues(unit.values());
        initialize1();
    });

    connect(reply, &QModbusReply::errorOccurred, m_initObject,
            [this, reply](QModbusDevice::Error error) {
                qCWarning(dcSolaxEvcModbusTcpConnection())
                        << "Modbus reply error occurred while reading \"Version\" registers from"
                        << hostAddress().toString() << error << reply->errorString();
            });
...
void SolaxEvcModbusTcpConnection::initialize1()
{
    ...
    // Read Device type
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read init \"Device type\" register:" << 4108 << "size:" << 1;
    reply = readDeviceType();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Device type\" registers from"
                << hostAddress().toString() << errorString();
        finishInitialization(false);
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, m_initObject, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from init \"Device type\" register" << 4108 << "size:" << 1
                << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, m_initObject,
            [this, reply](QModbusDevice::Error error) {
                qCWarning(dcSolaxEvcModbusTcpConnection())
                        << "Modbus reply error occurred while reading \"Device type\" registers "
                           "from"
                        << hostAddress().toString() << error << reply->errorString();
            });
}
...
void SolaxEvcModbusTcpConnection::initialize2()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read init \"Firmware version\" register:" << 4133 << "size:" << 1;
    reply = readFirmwareVersion();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Firmware version\" registers from"
                << hostAddress().toString() << errorString();
        finishInitialization(false);
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, m_initObject, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from init \"Firmware version\" register" << 4133 << "size:" << 1
                << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, m_initObject,
            [this, reply](QModbusDevice::Error error) {
                qCWarning(dcSolaxEvcModbusTcpConnection())
                        << "Modbus reply error occurred while reading \"Firmware version\" "
                           "registers from"
                        << hostAddress().toString() << error << reply->errorString();
            });
}
...
bool SolaxEvcModbusTcpConnection::update()
{
    ...
    if (!m_pendingUpdateReplies.isEmpty()) {
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "Tried to update but there are still some update replies pending. Waiting for "
                   "them to be finished...";
        return true;
    }
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Accumulated charging energy\" register:" << 4121 << "size:" << 2;
    reply = readTotalEnergy();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Accumulated charging energy\" registers from"
                << hostAddress().toString() << errorString();
        return false;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from \"Accumulated charging energy\" register" << 4121
                << "size:" << 2 << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Accumulated charging energy\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
...
void SolaxEvcModbusTcpConnection::update1()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Control command\" register:" << 4135 << "size:" << 2;
    reply = readControlCommand();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Control command\" registers from"
                << hostAddress().toString() << errorString();
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection()) << "<-- Response from \"Control command\" register"
                                                 << 4135 << "size:" << 2 << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Control command\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update2()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Maximum current fast mode\" register:" << 4175 << "size:" << 2;
    reply = readMaxCurrent();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Maximum current fast mode\" registers from"
                << hostAddress().toString() << errorString();
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from \"Maximum current fast mode\" register" << 4175
                << "size:" << 2 << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Maximum current fast mode\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update3()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Duration of current charging session\" register:" << 4139
            << "size:" << 2;
    reply = readChargingTime();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection()) << "Error occurred while reading \"Duration of "
                                                      "current charging session\" registers from"
                                                   << hostAddress().toString() << errorString();
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from \"Duration of current charging session\" register" << 4139
                << "size:" << 2 << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Duration of current charging "
                   "session\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update4()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Minimum AC line current\" register:" << 4159 << "size:" << 1;
    reply = readMinCurrent();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Minimum AC line current\" registers from"
                << hostAddress().toString() << errorString();
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from \"Minimum AC line current\" register" << 4159 << "size:" << 1
                << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Minimum AC line current\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update5()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read \"Own 485 address\" register:" << 4160 << "size:" << 1;
    reply = readSlaveAddress();
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading \"Own 485 address\" registers from"
                << hostAddress().toString() << errorString();
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QModbusDataUnit unit = reply->result();
        qCDebug(dcSolaxEvcModbusTcpConnection()) << "<-- Response from \"Own 485 address\" register"
                                                 << 4160 << "size:" << 1 << unit.values();
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while reading \"Own 485 address\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update6()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read block \"meterValues\" registers from:" << 4096 << "size:" << 16;
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading block \"meterValues\" registers";
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from reading block \"meterValues\" register" << 4096
                << "size:" << 16 << blockValues;
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating block \"meterValues\" registers"
...
void SolaxEvcModbusTcpConnection::update7()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read block \"wallboxStatus\" registers from:" << 4124 << "size:" << 9;
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading block \"wallboxStatus\" registers";
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QVector<quint16> blockValues = unit.values();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from reading block \"wallboxStatus\" register" << 4124
                << "size:" << 9 << blockValues;
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating block \"wallboxStatus\" registers"
                << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::update8()
{
    ...
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Read block \"deviceSettings\" registers from:" << 4109 << "size:" << 10;
    if (!reply) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Error occurred while reading block \"deviceSettings\" registers";
        return;
    }
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        const QVector<quint16> blockValues = unit.values();
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "<-- Response from reading block \"deviceSettings\" register" << 4109
                << "size:" << 10 << blockValues;
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating block \"deviceSettings\" registers"
                << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateTotalEnergy()
{
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Accumulated charging energy\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateControlCommand()
{
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        if (reply->error() == QModbusDevice::NoError) {
            const QModbusDataUnit unit = reply->result();
            qCDebug(dcSolaxEvcModbusTcpConnection())
                    << "<-- Response from \"Control command\" register" << 4135 << "size:" << 2
                    << unit.values();
            processControlCommandRegisterValues(unit.values());
        }
    });
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Control command\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateMaxCurrent()
{
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Maximum current fast mode\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateChargingTime()
{
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Duration of current charging "
                   "session\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateMinCurrent()
{
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        if (reply->error() == QModbusDevice::NoError) {
            const QModbusDataUnit unit = reply->result();
            qCDebug(dcSolaxEvcModbusTcpConnection())
                    << "<-- Response from \"Minimum AC line current\" register" << 4159
                    << "size:" << 1 << unit.values();
            processMinCurrentRegisterValues(unit.values());
        }
    });
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Minimum AC line current\" "
                   "registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
void SolaxEvcModbusTcpConnection::updateSlaveAddress()
{
    ...
    connect(reply, &QModbusReply::finished, this, [this, reply]() {
        ...
        if (reply->error() == QModbusDevice::NoError) {
            const QModbusDataUnit unit = reply->result();
            qCDebug(dcSolaxEvcModbusTcpConnection())
                    << "<-- Response from \"Own 485 address\" register" << 4160 << "size:" << 1
                    << unit.values();
            processSlaveAddressRegisterValues(unit.values());
        }
    });
    ...
    connect(reply, &QModbusReply::errorOccurred, this, [this, reply](QModbusDevice::Error error) {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Modbus reply error occurred while updating \"Own 485 address\" registers from"
                << hostAddress().toString() << error << reply->errorString();
    });
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4096, 14);
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4108, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4121, 2);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4132, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4133, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4135, 2);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4175, 2);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4139, 2);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4155, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4159, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4160, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4096, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4097, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4098, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4099, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4100, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4101, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4102, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4103, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4104, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4105, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4106, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4107, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4108, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4109, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4110, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4111, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4124, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4125, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4126, 2);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4128, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4129, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4130, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4131, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4132, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4109, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4110, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4111, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4112, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4113, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4114, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4115, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4116, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4117, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4118, 1);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4096, 16);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::InputRegisters, 4124, 9);
    return sendReadRequest(request, m_slaveId);
}
...
{
    QModbusDataUnit request =
            QModbusDataUnit(QModbusDataUnit::RegisterType::HoldingRegisters, 4109, 10);
    return sendReadRequest(request, m_slaveId);
}
...
{
    float receivedTotalEnergy =
            ModbusDataUtils::convertToUInt32(values, m_endianness) * 1.0 * pow(10, -1);
...
void SolaxEvcModbusTcpConnection::processDataHubChargeCurrentRegisterValues(
        const QVector<quint16> values)
{
    float receivedDataHubChargeCurrent =
            ModbusDataUtils::convertToUInt16(values) * 1.0 * pow(10, -2);
...
void SolaxEvcModbusTcpConnection::processFirmwareVersionRegisterValues(
        const QVector<quint16> values)
{
...
{
    ControlCommand receivedControlCommand =
            static_cast<ControlCommand>(ModbusDataUtils::convertToUInt32(values, m_endianness));
...
{
    float receivedMaxCurrent =
            ModbusDataUtils::convertToUInt32(values, m_endianness) * 1.0 * pow(10, -2);
...
{
    quint32 receivedChargingTime =
            ModbusDataUtils::convertToUInt32(values, ModbusDataUtils::ByteOrderBigEndian);
...
{
    ChargePhase receivedChargePhase =
            static_cast<ChargePhase>(ModbusDataUtils::convertToUInt16(values));
...
void SolaxEvcModbusTcpConnection::processFrequencyPhaseARegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::processFrequencyPhaseBRegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::processFrequencyPhaseCRegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::processStartChargeModeRegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::processMainBreakerLimitRegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::processCardActivateSwitchRegisterValues(
        const QVector<quint16> values)
{
...
void SolaxEvcModbusTcpConnection::handleModbusError(QModbusDevice::Error error)
{
    if (error == QModbusDevice::NoError) {
        ...
        if (!m_communicationWorking)
            qCDebug(dcSolaxEvcModbusTcpConnection())
                    << "Received a reply without any errors. The communication with the device "
                       "seems to work now.";
        ...
        if (m_communicationWorking && m_communicationFailedCounter >= m_communicationFailedMax) {
            m_communicationWorking = false;
            qCWarning(dcSolaxEvcModbusTcpConnection())
                    << "Received" << m_communicationFailedCounter
                    << "errors while communicating with the RTU master. Mark as not reachable "
                       "until the communication works again.";
            evaluateReachableState();
        }
    }
}
...
void SolaxEvcModbusTcpConnection::testReachability()
{
    ...
    // Try to read the check reachability register firmwareVersion in order to verify if the
    // communication is working or not.
    qCDebug(dcSolaxEvcModbusTcpConnection())
            << "--> Test reachability by reading \"Firmware version\" register:" << 4133
            << "size:" << 1;
    m_checkRechableReply = readFirmwareVersion();
    if (!m_checkRechableReply) {
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "Error occurred verifying reachability by reading \"Firmware version\" register";
    ...
    connect(m_checkRechableReply, &QModbusReply::errorOccurred, this,
            [this](QModbusDevice::Error error) {
                qCDebug(dcSolaxEvcModbusTcpConnection())
                        << "Modbus reply error occurred while verifying reachability by reading "
                           "\"Firmware version\" register"
                        << error << m_checkRechableReply->errorString();
            });
}
...
void SolaxEvcModbusTcpConnection::finishInitialization(bool success)
{
    if (success) {
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "Initialization finished of SolaxEvcModbusTcpConnection"
                << hostAddress().toString() << "finished successfully";
    } else {
        qCWarning(dcSolaxEvcModbusTcpConnection())
                << "Initialization finished of SolaxEvcModbusTcpConnection"
                << hostAddress().toString() << "failed.";
    }
...
void SolaxEvcModbusTcpConnection::onReachabilityCheckFailed()
{
    ...
    if (m_checkReachableRetriesCount <= m_checkReachableRetries) {
        qCDebug(dcSolaxEvcModbusTcpConnection())
                << "Reachability test failed. Retry in on second" << m_checkReachableRetriesCount
                << "/" << m_checkReachableRetries;
...
{
    debug.nospace().noquote() << "SolaxEvcModbusTcpConnection("
                              << solaxEvcModbusTcpConnection->hostAddress().toString() << ":"
                              << solaxEvcModbusTcpConnection->port() << ")"
                              << "\n";
    ...
    debug.nospace().noquote() << "    - Device type: " << solaxEvcModbusTcpConnection->deviceType()
                              << "\n";
    debug.nospace().noquote() << "    - Accumulated charging energy: "
                              << solaxEvcModbusTcpConnection->totalEnergy() << " [kWh]"
                              << "\n";
    debug.nospace().noquote() << "    - Data hub charge current: "
                              << solaxEvcModbusTcpConnection->DataHubChargeCurrent() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Firmware version: "
                              << solaxEvcModbusTcpConnection->firmwareVersion() << "\n";
    debug.nospace().noquote() << "    - Control command: "
                              << solaxEvcModbusTcpConnection->controlCommand() << "\n";
    debug.nospace().noquote() << "    - Maximum current fast mode: "
                              << solaxEvcModbusTcpConnection->MaxCurrent() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Duration of current charging session: "
                              << solaxEvcModbusTcpConnection->chargingTime() << " [s]"
                              << "\n";
    debug.nospace().noquote() << "    - Wallbox phase configuration: "
                              << solaxEvcModbusTcpConnection->chargePhase() << "\n";
    debug.nospace().noquote() << "    - Minimum AC line current: "
                              << solaxEvcModbusTcpConnection->MinCurrent() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Own 485 address: "
                              << solaxEvcModbusTcpConnection->slaveAddress() << "\n";
    debug.nospace().noquote() << "    - Voltage phase A: "
                              << solaxEvcModbusTcpConnection->voltagePhaseA() << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Voltage phase B: "
                              << solaxEvcModbusTcpConnection->voltagePhaseB() << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Voltage phase C: "
                              << solaxEvcModbusTcpConnection->voltagePhaseC() << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Voltage PE: " << solaxEvcModbusTcpConnection->voltagePe()
                              << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Current phase A: "
                              << solaxEvcModbusTcpConnection->currentPhaseA() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Current phase B: "
                              << solaxEvcModbusTcpConnection->currentPhaseB() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Current phase C: "
                              << solaxEvcModbusTcpConnection->currentPhaseC() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Current PE: " << solaxEvcModbusTcpConnection->currentPe()
                              << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Power phase A: "
                              << solaxEvcModbusTcpConnection->powerPhaseA() << " [W]"
                              << "\n";
    debug.nospace().noquote() << "    - Power phase B: "
                              << solaxEvcModbusTcpConnection->powerPhaseB() << " [W]"
                              << "\n";
    debug.nospace().noquote() << "    - Power phase C: "
                              << solaxEvcModbusTcpConnection->powerPhaseC() << " [W]"
                              << "\n";
    debug.nospace().noquote() << "    - Total charging power: "
                              << solaxEvcModbusTcpConnection->totalPower() << " [W]"
                              << "\n";
    debug.nospace().noquote() << "    - Frequency phase A: "
                              << solaxEvcModbusTcpConnection->frequencyPhaseA() << " [Hz]"
                              << "\n";
    debug.nospace().noquote() << "    - Frequency phase B: "
                              << solaxEvcModbusTcpConnection->frequencyPhaseB() << " [Hz]"
                              << "\n";
    debug.nospace().noquote() << "    - Frequency phase C: "
                              << solaxEvcModbusTcpConnection->frequencyPhaseC() << " [Hz]"
                              << "\n";
    debug.nospace().noquote() << "    - Single charge energy: "
                              << solaxEvcModbusTcpConnection->sessionEnergy() << " [kWh]"
                              << "\n";
    debug.nospace().noquote() << "    - PCB temperature: " << solaxEvcModbusTcpConnection->tempPcb()
                              << " [°C]"
                              << "\n";
    ...
    debug.nospace().noquote() << "    - Fault code: " << solaxEvcModbusTcpConnection->faultCode()
                              << "\n";
    debug.nospace().noquote() << "    - Wallbox model case type: "
                              << solaxEvcModbusTcpConnection->typeCase() << "\n";
    debug.nospace().noquote() << "    - Wallbox is 7kW, 11kW or 22kW: "
                              << solaxEvcModbusTcpConnection->typePower() << "\n";
    debug.nospace().noquote() << "    - Wallbox is single or three phase: "
                              << solaxEvcModbusTcpConnection->typePhase() << "\n";
    debug.nospace().noquote() << "    - Wallbox is type home or OCPP: "
                              << solaxEvcModbusTcpConnection->typeCharger() << "\n";
    debug.nospace().noquote() << "    - Wallbox model has screen or not: "
                              << solaxEvcModbusTcpConnection->typeScreen() << "\n";
    ...
    debug.nospace().noquote() << "    - Green gear: " << solaxEvcModbusTcpConnection->greenGear()
                              << "\n";
    debug.nospace().noquote() << "    - Start charge mode: "
                              << solaxEvcModbusTcpConnection->startChargeMode() << "\n";
    debug.nospace().noquote() << "    - Over voltage setting: "
                              << solaxEvcModbusTcpConnection->overVoltSet() << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Under voltage setting: "
                              << solaxEvcModbusTcpConnection->underVoltSet() << " [V]"
                              << "\n";
    debug.nospace().noquote() << "    - Boost mode: " << solaxEvcModbusTcpConnection->boostMode()
                              << "\n";
    debug.nospace().noquote() << "    - Main breaker limit: "
                              << solaxEvcModbusTcpConnection->mainBreakerLimit() << " [A]"
                              << "\n";
    debug.nospace().noquote() << "    - Electronic Lock: "
                              << solaxEvcModbusTcpConnection->electronicLock() << "\n";
    debug.nospace().noquote() << "    - Card activate switch: "
                              << solaxEvcModbusTcpConnection->CardActivateSwitch() << "\n";
