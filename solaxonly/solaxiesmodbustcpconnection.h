...
#ifndef SOLAXIESMODBUSTCPCONNECTION_H
#define SOLAXIESMODBUSTCPCONNECTION_H
...
class SolaxIesModbusTcpConnection : public ModbusTcpMaster
{
    Q_OBJECT
public:
    enum Registers {
    ...
    explicit SolaxIesModbusTcpConnection(const QHostAddress &hostAddress, uint port, quint16 slaveId, QObject *parent = nullptr);
    ~SolaxIesModbusTcpConnection() = default;
...
QDebug operator<<(QDebug debug, SolaxIesModbusTcpConnection *solaxIesModbusTcpConnection);
