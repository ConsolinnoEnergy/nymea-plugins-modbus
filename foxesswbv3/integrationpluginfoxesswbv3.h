...
class IntegrationPluginFoxEss : public IntegrationPlugin
{
    ...
    Q_PLUGIN_METADATA(IID "io.nymea.IntegrationPlugin" FILE "integrationpluginfoxesswbv3.json")
...
private:
    ...
    void setMaxCurrent(FoxESSModbusTcpConnection *connection, float maxCurrent);
};
