...
#define MIN_FIRMWARE_VERSION_MAJOR      0x01
#define MIN_FIRMWARE_VERSION_MINOR      0x00
#define MIN_FIRMWARE_VERSION_REVISION   0x00

#define MIN_FIRMWARE_VERSION ((MIN_FIRMWARE_VERSION_MAJOR << 24) | (MIN_FIRMWARE_VERSION_MINOR << 16) | (MIN_FIRMWARE_VERSION_REVISION << 8))
