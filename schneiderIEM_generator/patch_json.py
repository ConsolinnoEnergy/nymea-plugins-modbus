...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generates a patched SchneiderIEM JSON plugin info.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument("JSON", help="Original JSON file")
    parser.add_argument("--output", help="Outputfile")
    parser.add_argument(
        "--interfaces", help="Interfaces of new SchneiderIEM plugin", required=True, nargs="+"
    )
    #    parser.add_argument(
    #        "--name", help="Name of new SchneiderIEM thing class", required=True
    #    )
    parser.add_argument(
        "--display_name", help="Display name of new SchneiderIEM thing", required=True
    )
    parser.add_argument(
