...
#ifndef FOXESSMODBUSTCPCONNECTION_H
#define FOXESSMODBUSTCPCONNECTION_H
...
public:
    ...
    explicit FoxESSModbusTcpConnection(const QHostAddress &hostAddress, uint port, quint16 slaveId, QObject *parent = nullptr);
    ~FoxESSModbusTcpConnection() = default;
...
#endif // FOXESSMODBUSTCPCONNECTION_H
